...
var noofdgts = data.length;
var tempAr = [], lessOneDigitNumber,lessOneDigitNumberWithoutRev=data.toString(), newNumber;
var finalString = '';
while(number>0) {
	...
	if(number < newNumber) {
		...
		finalString = finalString + newTemp + newArr.sort().join('');
		break;
	}
	number = 0;
}
